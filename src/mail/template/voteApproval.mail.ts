export function VoteApprovalTemplate({
  vote,
  organizer,
  approveLink,
}: {
  ...
  return `
    <div style="font-family: Arial, sans-serif; background:#0A0A0A; padding:40px;">
      <div style="max-width:600px; margin:auto; background:#151515; padding:30px; border-radius:12px;">
        ...
        <h2 style="color:#F9F7F4; margin-bottom:4px;">Vote Approval Request</h2>
        <p style="color:#888; margin-top:0;">
          A new vote has been created and is awaiting your approval.
        </p>
        ...
        <div style="background:#1a1a1a; border:1px solid #2a2a2a; border-radius:10px; padding:20px; margin:24px 0;">
          <table style="width:100%; border-collapse:collapse;">
            ...
            <tr>
              <td style="color:#888; padding:8px 0; font-size:13px;">Vote Title</td>
            ...
            <tr>
              <td style="color:#888; padding:8px 0; font-size:13px; border-top:1px solid #2a2a2a;">Edition</td>
            ...
            <tr>
              <td style="color:#888; padding:8px 0; font-size:13px; border-top:1px solid #2a2a2a;">Voting Starts</td>
              <td style="color:#FFD159; padding:8px 0; font-size:13px; text-align:right; border-top:1px solid #2a2a2a;">
                ${new Date(vote.voteStart).toLocaleString()}
              </td>
            </tr>

            <tr>
              <td style="color:#888; padding:8px 0; font-size:13px; border-top:1px solid #2a2a2a;">Voting Ends</td>
              <td style="color:#FFD159; padding:8px 0; font-size:13px; text-align:right; border-top:1px solid #2a2a2a;">
                ${new Date(vote.voteEnd).toLocaleString()}
              </td>
            </tr>
        ...
        <p style="color:#b3b3b3; font-size:13px;">
          Review the vote details carefully. Click the button below to approve this vote.
        </p>
        ...
        <p style="color:#444; font-size:11px; margin-top:24px;">
          Only click this button if you have verified the vote. This action may be irreversible.
        </p>
      </div>
    </div>
  `;
